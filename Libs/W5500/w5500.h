...
extern W5500_Config w5500cfg;
extern uint16 local_port; /* 当前本地端口 */
...
void PHY_check(void);
uint8 getPHYCFG(void);
void setPHYCFG(uint8 v);

/**
 @brief WIZCHIP_OFFSET_INC on w5500_Read/WRITE
 * case1.
 *  w5500_WriteBytes(RTR0,val);
 *  w5500_WriteBytes(RTR1,val);
 * case1.
 *  w5500_WriteBytes(RTR0,val);
 *  w5500_WriteBytes(WIZCHIP_OFFSET_INC(RTR0,1));
 */
