...
//			mbedtls_printf("MBEDTLS_SSL_HELLO_REQUEST\n");
            ssl->state = MBEDTLS_SSL_CLIENT_HELLO;
            break;
...
//		   mbedtls_printf("MBEDTLS_SSL_CLIENT_HELLO\n");
...
//		   mbedtls_printf("MBEDTLS_SSL_SERVER_HELLO\n");
...
//		   mbedtls_printf("MBEDTLS_SSL_SERVER_KEY_EXCHANGE\n");
           ret = ssl_parse_server_key_exchange( ssl );
           break;

       case MBEDTLS_SSL_CERTIFICATE_REQUEST:
//		   mbedtls_printf("MBEDTLS_SSL_CERTIFICATE_REQUEST\n");
           ret = ssl_parse_certificate_request( ssl );
           break;

       case MBEDTLS_SSL_SERVER_HELLO_DONE:
//		   mbedtls_printf("MBEDTLS_SSL_SERVER_HELLO_DONE\n");
...
//			mbedtls_printf("MBEDTLS_SSL_CLIENT_CERTIFICATE\n");
           ret = mbedtls_ssl_write_certificate( ssl );
           break;

       case MBEDTLS_SSL_CLIENT_KEY_EXCHANGE:
//		   mbedtls_printf("MBEDTLS_SSL_CLIENT_KEY_EXCHANGE\n");
           ret = ssl_write_client_key_exchange( ssl );
           break;

       case MBEDTLS_SSL_CERTIFICATE_VERIFY:
//		   mbedtls_printf("MBEDTLS_SSL_CERTIFICATE_VERIFY\n");
           ret = ssl_write_certificate_verify( ssl );
           break;

       case MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC:
//		   mbedtls_printf("MBEDTLS_SSL_CLIENT_CHANGE_CIPHER_SPEC\n");
           ret = mbedtls_ssl_write_change_cipher_spec( ssl );
           break;

       case MBEDTLS_SSL_CLIENT_FINISHED:
//		   mbedtls_printf("MBEDTLS_SSL_CLIENT_FINISHED\n");
...
//		   mbedtls_printf("MBEDTLS_SSL_SERVER_CHANGE_CIPHER_SPEC\n");
           ret = mbedtls_ssl_parse_change_cipher_spec( ssl );
           break;

       case MBEDTLS_SSL_SERVER_FINISHED:
		   mbedtls_printf("MBEDTLS_SSL_SERVER_FINISHED\n");
           ret = mbedtls_ssl_parse_finished( ssl );
           break;

       case MBEDTLS_SSL_FLUSH_BUFFERS:
		   mbedtls_printf("MBEDTLS_SSL_FLUSH_BUFFERS\n");
           MBEDTLS_SSL_DEBUG_MSG( 2, ( "handshake: done" ) );
           ssl->state = MBEDTLS_SSL_HANDSHAKE_WRAPUP;
           break;

       case MBEDTLS_SSL_HANDSHAKE_WRAPUP:
		   mbedtls_printf("MBEDTLS_SSL_HANDSHAKE_WRAPUP\n");
           mbedtls_ssl_handshake_wrapup( ssl );
           break;

       default:
		   mbedtls_printf("MBEDTLS_SSL_HANDSHAKE_INVALIDSTATE\n");
