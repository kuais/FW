...
#define os_sys_init_user(tsk, prio, stk, size) os_sys_init0(tsk, prio | (size << 8), stk)
#define os_tsk_create(tsk, prio) os_tsk_create0(tsk, prio, NULL, NULL)
#define os_tsk_create_user(tsk, prio, stk, size) os_tsk_create0(tsk, prio | (size << 8), stk, NULL)
#define os_tsk_create_ex(tsk, prio, argv) os_tsk_create_ex0(tsk, prio, NULL, argv)
#define os_tsk_create_user_ex(tsk, prio, stk, size, argv) os_tsk_create_ex0(tsk, prio | (size << 8), stk, argv)
...
#define os_tsk_create_user(tsk, prio, stk, size) _os_tsk_create((U32)rt_tsk_create, tsk, prio | (size << 8), stk, NULL)
#define os_tsk_create_ex(tsk, prio, argv) _os_tsk_create_ex((U32)rt_tsk_create, tsk, prio, NULL, argv)
#define os_tsk_create_user_ex(tsk, prio, stk, size, argv) _os_tsk_create_ex((U32)rt_tsk_create, tsk, prio | (size << 8), stk, argv)
...
extern OS_RESULT _os_evt_wait(U32 p, U16 wait_flags, U16 timeout, BOOL and_wait) __SVC_0;
...
extern void _os_sem_init(U32 p, OS_ID semaphore, U16 token_count) __SVC_0;
...
extern OS_RESULT _os_mbx_send(U32 p, OS_ID mailbox, void *message_ptr, U16 timeout) __SVC_0;
extern OS_RESULT _os_mbx_wait(U32 p, OS_ID mailbox, void **message, U16 timeout) __SVC_0;
...
#pragma pop
    ...
    extern U8 udp_get_socket(U8 tos, U8 opt, U16 (*listener)(U8 socket, U8 *remip, U16 port, U8 *buf, U16 len));
    ...
    extern U8 tcp_get_socket(U8 type, U8 tos, U16 tout, U16 (*listener)(U8 socket, U8 event, U8 *buf, U16 len));
    ...
    extern BOOL tftpc_put(U8 *ipadr, U16 port, const char *src, const char *dst, void (*cbfunc)(U8 event));
    extern BOOL tftpc_get(U8 *ipadr, U16 port, const char *src, const char *dst, void (*cbfunc)(U8 event));
